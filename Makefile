...
ifeq ($(PLATFORM), RPI)
	...
	# CFLAGS += -DSTANDALONE -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS -DTARGET_POSIX -D_LINUX -fPIC -DPIC -D_REENTRANT -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -U_FORTIFY_SOURCE -g 
	CFLAGS += -DHAVE_LIBOPENMAX=2 -DOMX -ftree-vectorize -pipe -DUSE_EXTERNAL_OMX 
