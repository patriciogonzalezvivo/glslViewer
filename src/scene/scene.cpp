...
bool Scene::loadShaders(const std::string &_fragmentShader, 
...
void Scene::renderDebug() {
    ...
    // Draw Bounding boxes
    {
        ...
        for (unsigned int i = 0; i < m_models.size(); i++) {
            m_models[i]->getBboxVbo()->draw( &m_wireframe3D_shader );
        }
    }
